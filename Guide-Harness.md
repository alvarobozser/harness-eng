...
1. Antes de empezar SIEMPRE:
   ...
   - Leer: `.harness/research/research-plan.md` (si existe)
   - Leer: `.harness/tech/tech-plan.md` (si existe)
...
### Inicialización: automática vía Leader

El harness no necesita un script de init externo. Al abrir el proyecto en Claude Code u OpenCode, el Leader (`agents.md`) se carga automáticamente desde `CLAUDE.md` / `AGENTS.md` y realiza las verificaciones de entorno internamente: detecta CodeGraph, lee el estado en memory y activa el agente correspondiente.
